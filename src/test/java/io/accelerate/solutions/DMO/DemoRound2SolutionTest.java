...
public class DemoRound2SolutionTest
{
    ...
    @Test
    void whenArraySumWithSingleElement() {
        assertThat(solution.arraySum(List.of(42)), equalTo(42));
    }
    ...
    @Test
    void whenArraySumWithMixedNumbers() {
        assertThat(solution.arraySum(List.of(10, -5, 3, -2, 7)), equalTo(13));
    }
    ...
    @Test
    void whenArraySumWithZeros() {
        assertThat(solution.arraySum(List.of(0, 0, 0)), equalTo(0));
    }
